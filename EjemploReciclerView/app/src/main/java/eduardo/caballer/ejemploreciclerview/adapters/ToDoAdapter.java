package eduardo.caballer.ejemploreciclerview.adapters;
...
import eduardo.caballer.ejemploreciclerview.R;
...
public class ToDoAdapter extends RecyclerView.Adapter<ToDoAdapter.ToDoVH> {
    ...
    public void onBindViewHolder(@NonNull ToDoVH holder, int position) {
        // Se llama de forma automática en base al elemento que tenemos que rellenar.
